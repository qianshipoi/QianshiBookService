...
{
    [Authorize(QianshiServicePermissions.Authors.Default)]
    public class AuthorAppService : QianshiServiceAppService, IAuthorAppService
    {
        ...
        [Authorize(QianshiServicePermissions.Authors.Create)]
        ...
        [Authorize(QianshiServicePermissions.Authors.Delete)]
        ...
        [Authorize(QianshiServicePermissions.Authors.Edit)]
