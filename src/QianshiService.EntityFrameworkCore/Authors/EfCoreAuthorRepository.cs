...
{
    public class EfCoreAuthorRepository : EfCoreRepository<QianshiServiceDbContext, Author, Guid>, IAuthorRepository
    {
        public EfCoreAuthorRepository(IDbContextProvider<QianshiServiceDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
