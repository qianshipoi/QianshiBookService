...
public class QianshiServiceDbContext :
    AbpDbContext<QianshiServiceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public QianshiServiceDbContext(DbContextOptions<QianshiServiceDbContext> options)
        : base(options)
    {
